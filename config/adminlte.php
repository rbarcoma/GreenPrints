        ...
        'Quagga' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'vendor/quagga/js/quagga.min.js'
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'vendor/quagga/js/quagga.js'
                ]
            ]
        ],
        ...
        'Chartjs' => [
            ...
            'files' => [
                [
                    ...
                    'location' => 'vendor/chartjs/js/chart.bundle.min.js'
                ],
            ],
        ],
        'Sweetalert2' => [
        ...
        'CustomCSS' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'css/custom.css',  // path is public/css/custom.css
                ],
            ],
        ],
    ],
